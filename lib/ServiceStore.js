...
var ServiceStore = (_dec = _mobx.action.bound, _dec2 = _mobx.action.bound, _dec3 = _mobx.action.bound, _dec4 = _mobx.action.bound, (_class = (_temp = /*#__PURE__*/function () {
  function ServiceStore(feathers, name, options) {
    ...
    this.idField = options.idField || this.idField; // if service has socket
  ...
  _createClass(ServiceStore, [{
    ...
    value: function setItems(data) {
      ...
      this.items = [].concat(_toConsumableArray(data), _toConsumableArray(this.items.filter(function (item) {
        return !data.find(function (i) {
          return i[_this2.idField] === item[_this2.idField];
        });
      })));
    }
  }, {
    ...
    value: function patchItems(items) {
      this.setItems(items);
      this.setItems([item]); // update single item
    }
  }, {
    key: "removeItems",
    value: function removeItems(items) {
      ...
      this.items = _objectSpread({}, this.items.filter(function (item) {
        return items.find(function (i) {
          return i[_this3.idField] === item[_this3.idField];
        });
      })); // update single item
    }
  }, {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                _item3 = _context4.sent;
                this.patchItems(_item3);
                _context4.next = 11;
                break;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 4;
                return this.service.patch(data, params);

              case 4:
                _item4 = _context5.sent;
                this.patchItems(_item4);
                _context5.next = 11;
                break;
